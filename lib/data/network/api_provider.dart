...
class APIProvider {
  ...
  Future request(APIRequestRepresentable request) async {
    ...
    } on ReturnMessage catch (e) {
      throw ReturnMessage(e.details);
    }
  }
  ...
  dynamic _returnResponse(Response<dynamic> response) {
    switch (response.statusCode) {
      ...
      case 409:
        throw ReturnMessage(response.body);
      default:
...
class ReturnMessage extends AppException {
  ReturnMessage(dynamic? details)
      : super(
          code: "409",
